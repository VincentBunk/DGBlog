<?php get_header(); ?>
        ...
        <div id="container">
            <div id="content">
				...
				<h1 class="page-title"><?php _e( 'Category Archives:', 'deinegeestblog-theme' ) ?> <span><?php single_cat_title() ?></span></span></h1>
				...
				<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'deinegeestblog-theme' )  ); ?>
				                    ...
				                    <div class="entry-utility">
				                        <?php if ( $cats_meow = cats_meow(', ') ) : ?>
										                        <span class="cat-links"><?php printf( __( 'Also posted in %s', 'deinegeestblog-theme' ), $cats_meow ) ?></span>
										                        <span class="meta-sep"> | </span>
										<?php endif ?>
				                        <span class="meta-sep"> | </span>
